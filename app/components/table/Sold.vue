...
function selectMachine(soldMachine: SoldMachine) {
  machineStore.setMachine(soldMachine.machine)
  navigateTo(`/detail/?id=${soldMachine.s_id}&location=${machineStore.filters.location}`)
}
</script>
